...
const SummaryCard = ({
  ...
  return (
    <div
      onClick={onSelect}
      className="bg-white border border-gray-300/40 rounded-xl overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative mr-4 group"
    > 
      <div
      ...
      >
        ...
        <button
          className="hidden group-hover:flex items-center gap-2 text-xs text-rose-500 font-medium bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-red-200 cursor-pointer absolute top-2 right-2"
          onClick={(e) => {
            e.stopPropagation()
            onDelete()
          }}
